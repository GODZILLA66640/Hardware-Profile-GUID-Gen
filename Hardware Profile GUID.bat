@echo off
 ...
 :run
color 4
title Hardware Profile GUID Generator
...
call :colorEcho 0f "Your Hardware Profile GUID is"
echo.
for /f "tokens=2*" %%a in ('reg query "HKEY_LOCAL_MACHINE\SYSTEM\CurrentControlSet\Control\IDConfigDB\Hardware Profiles\0001" /v HwProfileGuid ^| findstr "REG_"') do @echo %%b
call :colorEcho 0f "Do you want a new Hardware Profile GUID"
echo.

call :colorEcho 04 "1.Generate new Hardware Profile GUID"
echo.
...
:Reg DIR
reg delete "HKLM\SYSTEM\CurrentControlSet\Control\IDConfigDB\Hardware Profiles\0001" /v HwProfileGuid /f >Nul
reg add "HKLM\SYSTEM\CurrentControlSet\Control\IDConfigDB\Hardware Profiles\0001" /v HwProfileGuid /d !deez! >Nul


call :colorEcho 0f "=========================================================================="
echo.
call :colorEcho 0f "["
call :colorEcho 0f "Your new Hardware Profile GUID is"
